class OrganizationsController < AdminController
  ...
  def organization_params
    if has_role 'admin'
        params.require(:organization).permit(:name, :slug, :parent_id, :lms_authentication_source, :lms_authentication_id, :lms_authentication_key, :lms_info_slug, :home_page_redirect, :skip_lms_publish, :enable_anonymous_actions, :track_meta_info_from_document, :enable_workflows, default_account_filter: [:account_filter])
    elsif has_role 'organization_admin'
        params.require(:organization).permit(:name, :lms_authentication_source, :lms_authentication_id, :lms_authentication_key, :lms_info_slug, :home_page_redirect, :skip_lms_publish, :enable_anonymous_actions, :track_meta_info_from_document, :enable_workflows)
    end
  end
end
